...
func dm_build_702(dm_build_703 *DmConnection) (*dm_build_690, error) {
	...
	dm_build_706.dm_build_693 = Dm_build_361(Dm_build_962)
...
func (dm_build_713 *dm_build_690) dm_build_712(dm_build_714 dm_build_1083) bool {
	var dm_build_715 = dm_build_713.dm_build_694.dmConnector.compress
	if dm_build_714.dm_build_1098() == Dm_build_990 || dm_build_715 == Dm_build_1039 {
		return false
	}

	if dm_build_715 == Dm_build_1037 {
		return true
	} else if dm_build_715 == Dm_build_1038 {
		return !dm_build_713.dm_build_694.Local && dm_build_714.dm_build_1096() > Dm_build_1036
	}

	return false
}

func (dm_build_717 *dm_build_690) dm_build_716(dm_build_718 dm_build_1083) bool {
	var dm_build_719 = dm_build_717.dm_build_694.dmConnector.compress
	if dm_build_718.dm_build_1098() == Dm_build_990 || dm_build_719 == Dm_build_1039 {
		return false
	}

	if dm_build_719 == Dm_build_1037 {
		return true
	} else if dm_build_719 == Dm_build_1038 {
		return dm_build_717.dm_build_693.Dm_build_621(Dm_build_998) == 1
	}

	return false
}

func (dm_build_721 *dm_build_690) dm_build_720(dm_build_722 dm_build_1083) (err error) {
	defer func() {
		if p := recover(); p != nil {
			if _, ok := p.(string); ok {
	...
	dm_build_724 := dm_build_722.dm_build_1096()

	if dm_build_724 > 0 {

		if dm_build_721.dm_build_712(dm_build_722) {
			var retBytes, err = Compress(dm_build_721.dm_build_693, Dm_build_991, int(dm_build_724), int(dm_build_721.dm_build_694.dmConnector.compressID))
			if err != nil {
				return err
			}

			dm_build_721.dm_build_693.Dm_build_372(Dm_build_991)

			dm_build_721.dm_build_693.Dm_build_409(dm_build_724)

			dm_build_721.dm_build_693.Dm_build_437(retBytes)

			dm_build_722.dm_build_1097(int32(len(retBytes)) + ULINT_SIZE)

			dm_build_721.dm_build_693.Dm_build_541(Dm_build_998, 1)
		}

		if dm_build_721.dm_build_697 {
			dm_build_724 = dm_build_722.dm_build_1096()
			var retBytes = dm_build_721.dm_build_695.Encrypt(dm_build_721.dm_build_693.Dm_build_648(Dm_build_991, int(dm_build_724)), true)

			dm_build_721.dm_build_693.Dm_build_372(Dm_build_991)

			dm_build_721.dm_build_693.Dm_build_437(retBytes)

			dm_build_722.dm_build_1097(int32(len(retBytes)))
		}
	}

	if dm_build_721.dm_build_693.Dm_build_370() > Dm_build_963 {
		return ECGO_MSG_TOO_LONG.throw()
	}

	dm_build_722.dm_build_1092()
	if dm_build_721.dm_build_952(dm_build_722) {
		if dm_build_721.dm_build_692 != nil {
			dm_build_721.dm_build_693.Dm_build_375(0)
			if _, err := dm_build_721.dm_build_693.Dm_build_394(dm_build_721.dm_build_692); err != nil {
				return err
			}
		}
	} else {
		dm_build_721.dm_build_693.Dm_build_375(0)
		if _, err := dm_build_721.dm_build_693.Dm_build_394(dm_build_721.dm_build_691); err != nil {
			return err
		}
	}
	return nil
...
func (dm_build_726 *dm_build_690) dm_build_725(dm_build_727 dm_build_1083) (err error) {
	defer func() {
		if p := recover(); p != nil {
			if _, ok := p.(string); ok {
				err = ECGO_COMMUNITION_ERROR.addDetail("\t" + p.(string)).throw()
	...
	if dm_build_726.dm_build_952(dm_build_727) {
		if dm_build_726.dm_build_692 != nil {
			...
			if _, err := dm_build_726.dm_build_693.Dm_build_388(dm_build_726.dm_build_692, Dm_build_991); err != nil {
				return err
			}

			dm_build_729 = dm_build_727.dm_build_1096()
			if dm_build_729 > 0 {
				if _, err := dm_build_726.dm_build_693.Dm_build_388(dm_build_726.dm_build_692, int(dm_build_729)); err != nil {
					return err
				}
			}
		}
		...
		dm_build_726.dm_build_693.Dm_build_372(0)
		if _, err := dm_build_726.dm_build_693.Dm_build_388(dm_build_726.dm_build_691, Dm_build_991); err != nil {
			return err
		}
		dm_build_729 = dm_build_727.dm_build_1096()

		if dm_build_729 > 0 {
			if _, err := dm_build_726.dm_build_693.Dm_build_388(dm_build_726.dm_build_691, int(dm_build_729)); err != nil {
				return err
			}
		}
	}

	dm_build_727.dm_build_1093()
	...
	if dm_build_726.dm_build_697 {
		ebytes := dm_build_726.dm_build_693.Dm_build_648(Dm_build_991, int(dm_build_729))
		bytes, err := dm_build_726.dm_build_695.Decrypt(ebytes, true)
		if err != nil {
			return err
		}
		dm_build_726.dm_build_693.Dm_build_372(Dm_build_991)
		dm_build_726.dm_build_693.Dm_build_437(bytes)
		dm_build_727.dm_build_1097(int32(len(bytes)))
	}

	if dm_build_726.dm_build_716(dm_build_727) {

		dm_build_729 = dm_build_727.dm_build_1096()
		cbytes := dm_build_726.dm_build_693.Dm_build_648(Dm_build_991+ULINT_SIZE, int(dm_build_729-ULINT_SIZE))
...
func (dm_build_731 *dm_build_690) dm_build_730(dm_build_732 dm_build_1083) (dm_build_733 interface{}, dm_build_734 error) {
	dm_build_734 = dm_build_732.dm_build_1087(dm_build_732)
	if dm_build_734 != nil {
	...
	return dm_build_732.dm_build_1091(dm_build_732)
}

func (dm_build_736 *dm_build_690) dm_build_735() (*dm_build_1520, error) {

	Dm_build_737 := dm_build_1526(dm_build_736)
...
func (dm_build_740 *dm_build_690) dm_build_739() error {
	...
	dm_build_741 := dm_build_1388(dm_build_740)
...
func (dm_build_744 *dm_build_690) dm_build_743() error {
	...
	var dm_build_745 *dm_build_1520
	var err error
	...
	if dm_build_744.dm_build_697 || dm_build_744.dm_build_696 {
		...
		sessionKey := security.ComputeSessionKey(k, dm_build_745.Dm_build_1524)
		encryptType := dm_build_745.dm_build_1522
		hashType := int(dm_build_745.Dm_build_1523)
		if encryptType == -1 {
...
func (dm_build_748 *dm_build_690) Dm_build_747(dm_build_749 *DmStatement) error {
	dm_build_750 := dm_build_1549(dm_build_748, dm_build_749)
...
func (dm_build_753 *dm_build_690) Dm_build_752(dm_build_754 int32) error {
	dm_build_755 := dm_build_1559(dm_build_753, dm_build_754)
...
func (dm_build_758 *dm_build_690) Dm_build_757(dm_build_759 *DmStatement, dm_build_760 bool, dm_build_761 int16) (*execRetInfo, error) {
	dm_build_762 := dm_build_1426(dm_build_758, dm_build_759, dm_build_760, dm_build_761)
...
func (dm_build_766 *dm_build_690) Dm_build_765(dm_build_767 *DmStatement, dm_build_768 int16) (*execRetInfo, error) {
	return dm_build_766.Dm_build_757(dm_build_767, false, Dm_build_1043)
}

func (dm_build_770 *dm_build_690) Dm_build_769(dm_build_771 *DmStatement, dm_build_772 []OptParameter) (*execRetInfo, error) {
	dm_build_773, dm_build_774 := dm_build_770.dm_build_730(dm_build_1185(dm_build_770, dm_build_771, dm_build_772))
	if dm_build_774 != nil {
...
func (dm_build_780 *dm_build_690) Dm_build_779(dm_build_781 *DmStatement, dm_build_782 [][]interface{}) (*execRetInfo, error) {
	dm_build_783 := dm_build_1208(dm_build_780, dm_build_781, dm_build_782)
...
func (dm_build_798 *dm_build_690) Dm_build_797(dm_build_799 *DmStatement, dm_build_800 []interface{}, dm_build_801 bool) (*execRetInfo, error) {
	...
	for icol := 0; icol < int(dm_build_799.paramCount); icol++ {
		...
		if dm_build_798.dm_build_921(dm_build_802, dm_build_800, icol) {
			...
			if !dm_build_801 {
				preExecute := dm_build_1416(dm_build_798, dm_build_799, dm_build_799.params)
	...
	dm_build_804 := dm_build_1208(dm_build_798, dm_build_799, dm_build_803)
...
func (dm_build_808 *dm_build_690) Dm_build_807(dm_build_809 *DmStatement, dm_build_810 int16) (*execRetInfo, error) {
	dm_build_811 := dm_build_1403(dm_build_808, dm_build_809, dm_build_810)
...
func (dm_build_815 *dm_build_690) Dm_build_814(dm_build_816 *innerRows, dm_build_817 int64) (*execRetInfo, error) {
	dm_build_818 := dm_build_1308(dm_build_815, dm_build_816, dm_build_817, INT64_MAX)
...
func (dm_build_822 *dm_build_690) Commit() error {
	dm_build_823 := dm_build_1171(dm_build_822)
...
func (dm_build_826 *dm_build_690) Rollback() error {
	dm_build_827 := dm_build_1464(dm_build_826)
...
func (dm_build_830 *dm_build_690) Dm_build_829(dm_build_831 *DmConnection) error {
	dm_build_832 := dm_build_1469(dm_build_830, dm_build_831.IsoLevel)
...
func (dm_build_835 *dm_build_690) Dm_build_834(dm_build_836 *DmStatement, dm_build_837 string) error {
	dm_build_838 := dm_build_1176(dm_build_835, dm_build_836, dm_build_837)
...
func (dm_build_841 *dm_build_690) Dm_build_840(dm_build_842 []uint32) ([]int64, error) {
	dm_build_843 := dm_build_1567(dm_build_841, dm_build_842)
...
func (dm_build_850 *dm_build_690) dm_build_849(dm_build_851 *lob) (int64, error) {
	dm_build_852 := dm_build_1339(dm_build_850, dm_build_851)
...
func (dm_build_856 *dm_build_690) dm_build_855(dm_build_857 *lob, dm_build_858 int32, dm_build_859 int32) ([]byte, error) {
	dm_build_860 := dm_build_1326(dm_build_856, dm_build_857, int(dm_build_858), int(dm_build_859))
...
func (dm_build_864 *dm_build_690) dm_build_863(dm_build_865 *DmBlob, dm_build_866 int32, dm_build_867 int32) ([]byte, error) {
	...
	for dm_build_869 < dm_build_867 {
		...
		if dm_build_870 > Dm_build_1076 {
			dm_build_870 = Dm_build_1076
		}
...
func (dm_build_874 *dm_build_690) dm_build_873(dm_build_875 *DmClob, dm_build_876 int32, dm_build_877 int32) (string, error) {
	...
	for dm_build_879 < dm_build_877 {
		...
		if dm_build_880 > Dm_build_1076/2 {
			dm_build_880 = Dm_build_1076 / 2
		}
		...
		strLen := utf8.RuneCountInString(dm_build_882)
		dm_build_879 += int32(strLen)
		dm_build_876 += int32(strLen)
...
func (dm_build_885 *dm_build_690) dm_build_884(dm_build_886 *DmClob, dm_build_887 int, dm_build_888 string, dm_build_889 string) (int, error) {
	...
	var dm_build_894 = 0
	var dm_build_895 = 0
	var dm_build_896 = dm_build_892/Dm_build_1075 + 1
	...
	for i := 0; i < dm_build_896; i++ {
		...
		if dm_build_895 > Dm_build_1075 {
			dm_build_895 = Dm_build_1075
		}

		setLobData := dm_build_1483(dm_build_885, &dm_build_886.lob, dm_build_897, dm_build_887, dm_build_890, dm_build_891, dm_build_895)
...
func (dm_build_901 *dm_build_690) dm_build_900(dm_build_902 *DmBlob, dm_build_903 int, dm_build_904 []byte) (int, error) {
	...
	var dm_build_908 = 0
	var dm_build_909 = 0
	var dm_build_910 = dm_build_906/Dm_build_1075 + 1
	...
	for i := 0; i < dm_build_910; i++ {
		...
		if dm_build_909 > Dm_build_1075 {
			dm_build_909 = Dm_build_1075
		}

		setLobData := dm_build_1483(dm_build_901, &dm_build_902.lob, dm_build_911, dm_build_903, dm_build_904, dm_build_905, dm_build_909)
...
func (dm_build_915 *dm_build_690) dm_build_914(dm_build_916 *lob, dm_build_917 int) (int64, error) {
	dm_build_918 := dm_build_1350(dm_build_915, dm_build_916, dm_build_917)
...
func (dm_build_928 *dm_build_690) dm_build_927(dm_build_929 *DmStatement, dm_build_930 parameter, dm_build_931 int, dm_build_932 iOffRowBinder) error {
	...
	for !dm_build_932.isReadOver() || dm_build_933.Dm_build_285() > 0 {
		if !dm_build_932.isReadOver() && dm_build_933.Dm_build_285() < Dm_build_1075 {
			dm_build_932.read(dm_build_933)
		}
		if dm_build_933.Dm_build_285() > Dm_build_1075 {
			dm_build_934 = Dm_build_1075
		} else {
			dm_build_934 = dm_build_933.Dm_build_285()
		}

		putData := dm_build_1454(dm_build_928, dm_build_929, int16(dm_build_931), dm_build_933, int32(dm_build_934))
...
func (dm_build_953 *dm_build_690) dm_build_952(dm_build_954 dm_build_1083) bool {
	return dm_build_954.dm_build_1098() != Dm_build_990 && dm_build_953.dm_build_694.sslEncrypt == 1
}
